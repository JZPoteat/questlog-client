    ...
    return (
      <form className="signup_form" onSubmit={this.handleSubmit}>
        ...
        <div className="user_name">
          <label htmlFor="signup_user_name">Username</label>
          <input
            required
            type="text"
            name="user_name"
        ...
        <div className="retype_password">
          <label
            htmlFor="signup_retype_password"
            className="signup_retype_password_label"
          >
            Retype Password
          </label>
          <input
        ...
        <Link to="/signup">
          <p id="signup_redirect">Already a user? Log in here</p>
        </Link>
