    ...
    return (
      <section className="welcome_back_section">
        ...
        <section id="game_review_selection_box">
          <p id="game_review_selection_title">
            Please select one of the following
          </p>
          <section id="game_review_options">
            <Link to="/games">
              <p id="games_tab">Games</p>
            </Link>
            <Link to="/reviews">
              <p id="reviews_tab">Reviews</p>
            </Link>
          </section>
        </section>
      </section>
    ...
    return (
      <section className="welcome_section">
        <h1 id="welcome_statement">
          Gaming to the next <i>level</i>
        </h1>
        <section id="welcome_box">
          <p>Store your games in one place</p>
          <p>
            Write and read reviews that <strong>actually make sense!</strong>
          </p>
          <Link to="/signup">
            <p id="here_button">Start your journey here!</p>
          </Link>
